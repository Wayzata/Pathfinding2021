...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    testTraj = trajectories.generateAutoTrajectoryFromCurrentPose(new Pose2d());
  ...
  public void autonomousInit() {
    ...
    mpController.createMecanumFollowerCommand(testTraj, Units.feetToMeters(2)).schedule();
