...
public class Trajectories {
     ...
     * Trajectory Configs 
     */
    TrajectoryConfig testConfig = new TrajectoryConfig(2, 2);
     ...
     * @return
     */
    public Trajectory generateAutoTrajectoryFromCurrentPose(Pose2d currentPose){
                return TrajectoryGenerator.generateTrajectory(
                    Arrays.asList(currentPose, new Pose2d(3.33, 0, Rotation2d.fromDegrees(0))), // Makes the robot go 5 feet in y direction on autonomousInit();
                    testConfig
                );
    }
